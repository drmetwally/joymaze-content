...
- [~] **ANIMAL-FACTS-001 — Build animal facts short using Story Reel structural reference**
  ...
  - Durable expansion rule (2026-05-07): longer / stronger Animal Facts songs should expand into a wider creative plan (typically 8-10 `visualExpansionMoments`), not just stretch 5 beat images longer.
  - Durable payoff rule (2026-05-07): the final expanded Animal Facts moment should usually be an explicit payoff image (home, burrow, chick, family, food delivery, etc.), not only a generic return/travel beauty shot.
