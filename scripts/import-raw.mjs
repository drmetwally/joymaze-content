...
async function importImage(filePath, index, scheduledHour = null, carouselOverride = null) {
  ...
  const metadata = {
    ...
    subject,
    source: sidecar?.source || 'manual-import',
    sourceFile: filename,
    ...
    dryRun: false,
    difficulty: sidecar?.difficulty || null,
    theme: sidecar?.theme || null,
    sourceFolder: sidecar?.sourceFolder || null,
    puzzleType: sidecar?.puzzleType || null,
    titleText: sidecar?.titleText || null,
    ctaText: sidecar?.ctaText || null,
