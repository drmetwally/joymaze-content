 ...
 *
 * Note on coloring ASMR:
 *   Folders generated by generate-coloring-assets.mjs (with activity.json + blank.png
 *   + colored.png) can be rendered directly via the AsmrReveal bridge:
 *     node scripts/render-video.mjs --comp AsmrReveal --challenge <coloring-folder>
 *   No manual asset wiring needed — the bridge resolves colored.png as the reveal end-state.
 *   For AI-generated coloring briefs (generate-asmr-brief.mjs), drop manually colored images into
 *   the brief output folder before rendering.
 */
